...
export default function SignUpForm() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    console.log('[v0] Callback URL will be:', `${window.location.origin}/auth/callback`)
    ...
    try {
      ...
      if (!data?.url) {
        console.error('[v0] No redirect URL returned from Supabase')
